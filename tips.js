...
//You'll know it's working if you see the following in /stacked_toads/data/deployments.json:
...
4. After successful deployment:
    ...
    and uncomment the following line in the stacked toads directory:
